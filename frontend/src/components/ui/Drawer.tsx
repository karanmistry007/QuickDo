...
const Drawer = (props: Props) => {
    ...
    return (
        <>
            {/* DRAWER CONTAINER */}
            <div className={`drawer-container bg-[#00000048] w-[100dvw] h-[100dvh] fixed left-0 top-0 z-50`}>
                ...
                <div className="drawer bg-[#00000046]  backdrop-blur-[2px] py-5 px-10 w-[100dvw] h-[100dvh] sm:w-[70dvw] md:w-[50dvw] lg:w-[40dvw] xl:w-[30dvw] ml-auto sm:rounded-s-3xl">
                    ...
                    <div className="drawer-navbar w-[calc(100%_-_80px)] pb-5 absolute">
                        <div className="nav-container flex justify-between  ">
                            ...
                            <div className="delete-todo w-fit p-1.5 bg-white shadow-[0px_0px_15px_0px_rgba(0,0,0,0.1)] rounded-full text-xl cursor-pointer"
                                onClick={() => { handleDeleteBoxDisplay(true) }}
                            >
                                <BsTrash />
                            </div>
                        </div>
                    ...
                    <div className="drawer-content h-full flex flex-col justify-center gap-5 sm:mt-5">
                        ...
                        <div className="todo-due-data flex items-center bg-white py-1.5 px-2 sm:py-2 sm:px-3 shadow-[0px_0px_15px_0px_rgba(0,0,0,0.1)] rounded-md gap-2 cursor-pointer select-none">
                            ...
                            <input type="date" className="outline-0 w-[124px] cursor-pointer" name="dueDate" id="dueDate" value={selectDueDate} onChange={(e) => { setSelectDueDate(e.target.value) }} />
                        </div>
                        {/* END TODO DUE DATE */}
            ...
            {/* CONFIRM BOX */}
            {showDeleteBox &&
                <ConfirmBox confirmMessage={"Are you sure you want to delete?"} handleConfirmBoxDisplay={handleDeleteBoxDisplay} handleSuccess={handleDeleteTodo} />
            }
            {/* END CONFIRM BOX */}
